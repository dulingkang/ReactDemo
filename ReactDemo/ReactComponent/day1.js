    ...
    return(
      <View style={styles.watchControlContainer}>
        <View style={{flex:1,alignItems:"flex-start"}}>
          <TouchableHighlight style={styles.btnStop} underlayColor={this.state.underlayColor} onPress={this.addRecord}>
...
export default class extends Component {
  ...
  render(){
    return(
      ...
      <WatchControl addRecord={this.addRecord} clearRecord={this.clearRecord} startWatch={this.startWatch} stopWatch={this.stopWatch}></WatchControl>
